...
class LoanProductCollection extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'links' => array(
                new LinkObject("show", "View Loan", route('loan-products.show', $this->id), "GET", 'fa-solid fa-eye'),
                Auth::user()?->role === 'Super Admin' || Auth::user()?->role === 'Admin' || Auth::user()?->role === 'Content Manager' || Auth::user()?->role === 'Content Creator' ? new LinkObject("update", "Update Loan", route('loan-products.update', $this->id), "PUT", 'fa-solid fa-pen-to-square') : null,
