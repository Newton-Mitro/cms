    ...
    public function toArray($request)
    {
        return [
            ...
            'links' => [
                ...
                Auth::user()?->role === 'Super Admin' || Auth::user()?->role === 'Admin' || Auth::user()?->role === 'Content Manager' || Auth::user()?->role === 'Content Creator' ? new LinkObject("update", "Edit Post", route('posts.update', $this->id), "PUT", 'fa-solid fa-pen-to-square') : null,
