...
interface GalleryImageSingleViewProps {
  pageInputState: any;
}

const GalleryImageSingleView: React.FC<GalleryImageSingleViewProps> = ({
  pageInputState,
}) => {
  return (
    <>
      ...
      >
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            <label htmlFor="image">Gallery Image Image</label>
            <img
              className="h-32"
...
export default GalleryImageSingleView;
