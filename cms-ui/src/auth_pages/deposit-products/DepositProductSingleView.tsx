...
interface DepositProductSingleViewProps {
  pageInputState: any;
}

const DepositProductSingleView: React.FC<DepositProductSingleViewProps> = ({
  pageInputState,
}) => {
  return (
    <>
      ...
      >
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            <label htmlFor="image">Deposit Product Image</label>
            <img
              className="h-32"
...
export default DepositProductSingleView;
