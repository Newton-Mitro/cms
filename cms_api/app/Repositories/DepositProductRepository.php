...
class DepositProductRepository implements DepositProductRepositoryInterface
{

    public function all($perPage, $searchText)
    {
        return DepositProduct::where('title', 'like', '%' . $searchText . '%')->orderBy('order', 'ASC')->paginate($perPage);
    }
    ...
    public function getPublicPosts()
    {
        ...
        return DepositProduct::where('publish_status', 'Published')->paginate($per_page);
    }

    public function show($id)
    {
        $post = DepositProduct::findOrFail($id);
        return $post;
    }

    public function getPostBySlug($slug)
    {
        return DepositProduct::where('slug', $slug)->where('publish_status', 'Published')->get()->firstOrFail();
    }

    public function store($request)
    {
        $post = new DepositProduct();
