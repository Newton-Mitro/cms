...
class PageCollection extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'links' => array(
                new LinkObject("show", "View Page", route('pages.show', $this->id), "GET", 'fa-solid fa-eye'),
                Auth::user()?->role === 'Super Admin' || Auth::user()?->role === 'Admin' || Auth::user()?->role === 'Content Manager' || Auth::user()?->role === 'Content Creator' ? new LinkObject("update", "Update Page", route('pages.update', $this->id), "PUT", 'fa-solid fa-pen-to-square') : null,
