...
interface LoanProductSingleViewProps {
  pageInputState: any;
}

const LoanProductSingleView: React.FC<LoanProductSingleViewProps> = ({
  pageInputState,
}) => {
  return (
    <>
      ...
      >
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            <label htmlFor="image">Loan Product Image</label>
            <img
              className="h-32"
...
export default LoanProductSingleView;
