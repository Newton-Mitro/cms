...
interface DownloadSingleViewProps {
  pageInputState: IDocumentPost;
}

const DownloadSingleView: React.FC<DownloadSingleViewProps> = ({
  pageInputState,
}) => {
  return (
    <>
...
export default DownloadSingleView;
