...
export default function ServiceDetails() {
  ...
  useEffect(() => {
    executeQuery(
      process.env.REACT_APP_BASE_URL + '/api/our-services/post-slug/' + slug,
      {}
    );
  }, []);
  ...
  return (
    ...
    >
      <div className="container mx-auto">
        ...
        <div className="bg-surface shadow-sm hover:shadow dark:bg-blue-gray-900 dark:text-onPrimary">
