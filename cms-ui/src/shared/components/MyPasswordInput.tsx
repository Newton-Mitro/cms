      ...
      >
        <div className="relative">
          <input
            ...
            } rounded border-onBorder bg-surface transition-colors focus:border-primary disabled:bg-onDisabled disabled:font-semibold disabled:text-primary dark:bg-gray-800 ${
              error ? 'border-error' : ''
            }`}
            onChange={(event) => {
          ...
          <label
            ...
            className={`absolute left-0 mx-3 duration-200 peer-focus:-top-2 ${
              error ? 'text-error' : 'text-primary dark:text-gray-200'
            } cursor-text rounded bg-surface px-1 text-sm transition-all dark:bg-gray-800
            ${
            ...
            peer-focus:ml-3 peer-focus:text-xs peer-focus:text-primary dark:peer-focus:text-gray-200`}
          >
            {label}
