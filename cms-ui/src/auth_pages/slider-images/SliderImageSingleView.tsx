...
interface SliderImageSingleViewProps {
  pageInputState: any;
}

const SliderImageSingleView: React.FC<SliderImageSingleViewProps> = ({
  pageInputState,
}) => {
  return (
    <>
      ...
      >
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            <label htmlFor="image">Slider Image Image</label>
            <img
              className="h-32"
...
export default SliderImageSingleView;
